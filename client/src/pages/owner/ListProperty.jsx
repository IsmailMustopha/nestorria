...
const ListProperty = () => {
  ...
  return (
    <div className="md:px-8 py-6 xl:py-8 m-1 sm:m-3 h-[97vh] overflow-y-scroll lg:w-11/">
      <div className="bg-white shadow rounded-xl">
        ...
        <div>
          {properties.map((property, index) => (
            <div
              key={index}
              className="flex justify-between items-center flex-wrap gap-2 sm:grid grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-secondary/5 text-gray-50 medium-14 font-semibold border-b-1 border-slate-900/15"
            >
