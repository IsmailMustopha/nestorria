...
const PropertyImages = ({ property }) => {
  ...
  const imageCaptions = [
    ...
    },
    {
      ...
      desc: "Fully equiped kitchen with sleek finishes and modern appliances",
    },
  ];
      ...
      {property.images.map((pImg, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-10 text-white bg-black/40 opacity-0 group-hover:opacity-100 transition-all duration-100 rounded-2xl">
